...
//
//// tbot.java
//// © 2006 Alejandro Lopez-Lago & Raghav Puranmalka
//// This part of the bot is the most complex.  It is also edited and improved by Raghav, so some of the formatting/style will look different -Alejandro
//// Apologies for any messy code; this project was started years ago before I
//// learned about some recommended coding practices (i.e. 80-character lines)

/* CURRENT CHANGE LOG (For overall change log, see changelog.txt)
...
??- Fix NullPointerException at either line 1883, 2358, 2324,or 2163
??- find a way to fix the loadSet bug when the set isn't changed [so it doesn't auto-reload]
...
public class TBot extends PircBot
{
        ...
        //ints (variable functions should be obvious)
